...
<body>
	...
	<div class="header">
		...
		<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-warning">
         ...
         String user_id2 = String.valueOf(session.getAttribute("login"));
			...
			<div class="row">
				...
				<div class="col-md-12"
					...
					<div class="bxslider">
						...
						<div>
							<!-- 쿠폰배너 이미지 a태그 링크로 클릭시 가입할인쿠폰(2500원할인)을 발급할 수 있도록 함 
						유효기간 30일  -->
							<a
								href="/takeCoupon?cp_idx=1&cp_name=반찬초잇가입할인쿠폰&cp_saleprice=2500"><img
	...
	<script>
		...
		/* 배너쿠폰이미지 클릭시 , 기존 아이디 쿠폰수령여부 확인 이미수령시 alert창 메시지  */
		if ("${fail}" == "coupon") {
			alert("이미 수령한 쿠폰입니다");
			location.href="/coupon";//쿠폰함으로 이동 ( 발급확인)
		}
	</script>
