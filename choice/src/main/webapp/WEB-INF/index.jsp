		...
		<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-warning">
			...
			<div class="collapse navbar-collapse" id="navbarCollapse">
				...
				<ul class="navbar-nav mr-auto">
					...
					<!-- nav-item : 메뉴 아이템  -->
					<!-- nav-link : 메뉴링크(클릭가능 ) -->
					<li class="nav-item active"><a class="nav-link" href="#">메뉴</a>
					</li>
					<li class="nav-item"><a class="nav-link" href="#">국</a></li>
					<li class="nav-item"><a class="nav-link" href="#">반찬</a></li>
					<li class="nav-item"><a class="nav-link" href="#">김치</a></li>
					<li class="nav-item"><a class="nav-link" href="#">정육/양념육</a></li>
