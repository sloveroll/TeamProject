...
<div class="box-padding-big grey-bg" style="margin-top: -50px; padding-top: 80px; padding-bottom: 230px;">
      ...
      <!-- 콘트롤러에서 받은 값을 찾음 -->
			<div class="row" style="margin-top:180px">
				...
				<div class="col-md-12 col-sm-12  mb-5   text-center" >
					<p><b class="text-warning">"${searchWord}"</b>검색어에 대한 검색결과가 없습니다</p>
				</div>
				<!-- 검색결과 있을시 -->
				<% } else {%>
				<div class="col-md-12 col-sm-12  mb-5   text-center" >
				<p>검색어 <b class="text-warning"> "${searchWord}" </b> 에 대한 검색결과로 
				<b class="text-warning"> "${searchCount}" </b>건을 찾았습니다</p>
				</div>
					...
					<div class="col-md-3 col-sm-6 ">
						...
						<div class="card" style="width: 15rem; margin-bottom: 30px;">
							...
							<div class="card-body">
								...
								<!-- 상품가격 -->
								<p class="card-text"><b>${sr.item_price}</b>원</p>
								<!-- 상품상세 페이지로 이동 -->
								<a href="itemDetail?item_idx=${sr.item_idx}"
									class="btn btn-warning" style="color: white;">메뉴상세</a>
								<!-- 장바구니 추가  -->
								<a href="/cartInsert?item_idx=${sr.item_idx}&item_price=${sr.item_price}&count=1" class="btn btn-warning"
									style="width: 82px; margin-left: 14px;"><i
