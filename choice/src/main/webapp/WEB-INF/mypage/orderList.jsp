...
<body>
                     ...
                     <td style="width: 200px;">총금액</td> -->
						...
						<c:forEach items="${ list }" var="dto">
							<tr height="50px">
								<td>${dto.or_idx}</td>
								<td><img
									src="../resources/itemUpload/${dto.item_thumbnail}"
									class="card-img-top" alt="${dto.item_thumbnail }"
								...
								<!--주문취소    -->
								<td><a href="orderDelete_ok?or_idx=${dto.or_idx}"><input
										type="submit" class="btn btn-success pull-right" value="주문취소"
										onclick="return confirm('정말로 주문취소하시겠습니까?');" /></a></td>
	...
	<!-- box-padding-big grey-bg 종료 -->
	<!--좌측하단 고객센터  -->
	<div class="box-padding-big5 grey-bg" style="
    height: 1000px;">
