...
<body>
	...
	<!-- 로그인폼  -->
	<div class="box-padding-big grey-bg" style="margin-top: 56px; height: 950px;">
	...
	<script>
		function checkValue() {
			inputForm = eval("document.loginInfo");//문자열 코드 그대로 함수 실행 eval()

			if (!inputForm.user_pw.value) {
				alert("비밀번호를 입력하세요");
				inputForm.user_pw.focus();//비밀번호  미입력 경고창 표시후 자동으로 , 마우스 포커스 들어옴 
