...
<body>
		...
		<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-warning">
			...
			<div class="collapse navbar-collapse" id="navbarCollapse">
				...
				<ul class="navbar-nav mr-auto">
					...
					<!-- nav-item : 메뉴 아이템  -->
					<!-- nav-link : 메뉴링크(클릭가능 ) -->
					<li class="nav-item active"><a class="nav-link" href="#">마이페이지-회원탈퇴</a>
					</li>
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<div class="jumbotron" style="padding-top: 20px;">
						...
						<form method="post" 
							onsubmit="return checkValue()" name="userInfo" id="userInfo" >

							<h3 style="text-align: center;">회원탈퇴</h3>

							<div class="form-group">

								<input type="text" class="form-control" placeholder="비밀번호입력해주세요"
									name="user_pw" maxlength="20" value="">
								<h1></h1>
							</div>
							
							
							<input type="submit" class="btn btn-warning form-control"
								value="탈퇴하기" style="margin-top: 21px;" onClick="deleteMember()" >

							<input type="button" value="탈퇴취소"
								class="btn btn-warning form-control" style="margin-top: 21px;"
								onclick="goFirstForm()">
	...
	<!-- 로그인폼종료  -->
			...
			<% } else if(deleteMsg =="성공"){ session.invalidate(); %>	 
...
<!-- 자바스크립트란 -->
 ...
 function deleteMember(){
	 ...
	 if(!document.userInfo.user_pw.value){
      ...
      if(check == true){
		 var deleteMember = confirm("정말로 탈퇴하시겠습니까?");
	
			//확인 클릭시 이동
			if(deleteMember == true) {
				document.getElementById("userInfo").action = "/deleteMember2";
			} else {
				//취소 클릭시 아무것도 없음
			}
