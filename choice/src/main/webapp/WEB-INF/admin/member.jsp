...
<body>
	...
	<div class="header">
		...
		<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-warning">
			...
			<a class="navbar-brand" href="http://localhost:8081/adminMain">관리자페이지-회원관리</a>
			<!--  admin -->
			<%
				...
				<div class="col-md-10 col-sm-12" style="height: 200px;">
					...
					<table cellpadding="0" cellspacing="0" border="1"
						...
						<tr height="50px" style="background-color: rgb(255, 190, 0);">
							...
							<td style="width: 200px;">회원비번</td>
							<td style="width: 200px;">회원이름</td>
							<td style="width: 300px;">회원이메일</td>
						...
						<c:forEach items="${viewAll }" var="list">
							<tr>
								...
								<td><a
									href="adminMemberDelete_ok?user_idx=${list.user_idx }"><input
