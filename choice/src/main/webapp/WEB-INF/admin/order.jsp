					...
					<table cellpadding="0" cellspacing="0" border="1"
						...
						<c:forEach items="${viewAll }" var="list">
							<tr>
								<td>${list.user_id }</td>
								<td>${list.or_idx }</td>
								<td>${list.or_receiver }</td>
								<td>${list.or_phone }</td>
								<td>${list.or_address }</td>
								<td>${list.or_address2  }</td>
								<td>${list.or_email }</td>
						...
						<tr height="100px" style="background-color: rgb(255, 190, 0);">
							...
							<td style="width: 100px;">주문현황</td>
							<td style="width: 100px;">주문현황수정</td>

						</tr>

						<c:forEach items="${viewAll }" var="list2">
							<tr>
								<td>${list2.or_buysum }</td>
								<td>${list2.or_coupon }</td>
								<td>${list2.or_delivery }</td>
								<td>${list2.or_totalsum }</td>
								<td>${list2.or_date }</td>
								<td>${list2.or_confirm }</td>
								<td><a href="confirmModifyForm?or_idx=${list2.or_idx}">수정</a></td>
