...
<body>
	...
	<div class="box-padding-big4 grey-bg"
		style="margin-top: 56px; height: 2500px;">
			...
			<div class="row">
				...
				<div class="col-md-10 col-sm-12" style="height: 200px;">
					...
					<table cellpadding="0" cellspacing="0" border="1"
						...
						<td style="width: 100px;color: white;font-weight: bold;background:#28a745;">수정</td>
						<td style="width: 100px;color: white;font-weight: bold;background: #28a745;">삭제</td>
						...
						<c:forEach items="${viewAll }" var="list">
							<tr>
								...
								<td><img
									src="../resources/itemUpload/${list.item_thumbnail }"
									class="card-img-top" alt="${list.item_thumbnail }"></td>
								<td><img
									src="../resources/itemUpload/${list.item_thumbnail2 }"
									class="card-img-top" alt="${list.item_thumbnail2 }"></td>
								<td><img
									src="../resources/itemUpload/${list.item_thumbnail3 }"
									class="card-img-top" alt="${list.item_thumbnail3 }"></td>
								<td><img
									src="../resources/itemUpload/${list.item_thumbnail4 }"
									class="card-img-top" alt="${list.item_thumbnail4 }"></td>
								<td>${list.item_sort }</td>
								<td><a href="productModifyForm?item_idx=${list.item_idx }">수정</a></td>
								<td><a href="productDelete_ok?item_idx=${list.item_idx }"><input
										type="submit" style="color: blue;" value="삭제"
										onclick="return confirm('정말로 삭제하시겠습니까?');"></input></a></td>
							</tr>
						</c:forEach>
					...
					<a href="productWriteForm"><input type="submit"
						class="btn btn-success pull-right" value="상품등록"
						style="float: right;" /></a>
