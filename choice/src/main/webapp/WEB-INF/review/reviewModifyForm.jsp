...
<body>
	...
	<div class="header">
		...
		<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-warning">
			...
			<a class="navbar-brand" href="http://localhost:8081/noticelist">고객제품리뷰수정게시판-제품리뷰수정</a>
			<!-- 로그인 프로필 logprofile -->
			<%
			...
			<div class="row" style="height: 400px;">
				...
				<div class="col-md-10 col-sm-12" style="height: 200px;">
					...
					<form onsubmit="return submitContents()"
						action="reviewModify_ok?review_idx=${dto.review_idx }"
						method="post" name="reviewInfo">
						...
						<table cellpadding="0" cellspacing="0" border="1"
							...
							<thead>
								<tr>
									<th colspan="2"
										style="background-color: #eeeeee; text-align: center;">리뷰
										글쓰기 양식</th>
								</tr>
							</thead>
							...
							<tbody>
								<tr>
									<td><input type="text" class="form-control"
										placeholder="리뷰글 제목" name="review_title" maxlength="50"
										value="${ dto.review_title }"></td>
								</tr>
								<tr>
									<td><textarea class="form-control" placeholder="리뷰글 내용"
											id="text_content" name="review_content" maxlength="2048"
											style="height: 350px;">${ dto.review_content }</textarea></td>
								</tr>
							</tbody>
						...
						<input type="submit" class="btn btn-success pull-right"
							value="리뷰수정" style="float: right;" onClick="reviewModify_ok()" />
	...
	<!--제품리뷰 글쓰기,글수정에 공백,띄어쓰기뿐일때 값없음 처리  -->
	<script>
		/* 둘중에 아무거나 쓰면 됨 
		var cont = $('#texta').val();
