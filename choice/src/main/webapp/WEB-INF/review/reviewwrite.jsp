			...
			<div class="row" style="height: 400px;">
				...
				<div class="col-md-10 col-sm-12" style="height: 200px; ">
					<form onsubmit="return submitContents()" action="reviewWrite_ok"
						method="post" name="reviewInfo"  enctype="multipart/form-data" style="width:76%">
						...
						<table cellpadding="0" cellspacing="0" border="1"
							...
							<tr>
									...
									<td>
									 <div class="form-inline " >
											<input type="text" class="form-control"
												placeholder="제품번호" name="review_item_idx" maxlength="50" />
												<div class="input-group"> <!-- 별점 -->
													  <div class="input-group-prepend">
				   									 <span class="input-group-text" id="basic-addon1" style="background-color: #EEEEEE; border-radius: 0 5px 5px 0;" >별점</span>
				  										</div>
				   									<input type="number" name="reviewScore" id="rating1" class="rating text-warning  
				   									border p-2 bg-white form-control"  value="5" aria-describedby="basic-addon1"/>
												 </div>
								...
								<tr>
									...
									<input type="text" class="form-control"
										placeholder="제품리뷰 제목" name="review_title" maxlength="30" />
								...
								<tr>
									...
									<td>
										<div class="input-group">
													  <div class="input-group-prepend">
		   									 <span class="input-group-text" id="basic-addon1" style="background-color: #EEEEEE;" >이미지</span>
		  										</div>
		   									<input type="file" name="review_thumbnail" class=" form-control"  style="line-height:19px"/>
		   								</div>	
		  									<!--  파일업로드-->
						...
						<div class="float-right">
							...
							<a class="btn btn-primary  mr-1" href="reviewlist">취소</a>
