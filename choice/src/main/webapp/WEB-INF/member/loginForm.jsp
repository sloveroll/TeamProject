...
<body>
   ...
   <!-- 로그인폼  -->
   <div class="box-padding-big grey-bg" style="margin-top: 56px; padding-bottom:100px">
         ...
         <div class="col-md-12">
            ...
            <div class="col-md-12">
               ...
               <div class="jumbotron" style="padding-top: 20px;">
                  ...
                  <form method="post" action="login_ok" onsubmit="return checkValue()" name="loginInfo" >
			...
			{
				out.println("<br>");
				out.println("<font color='red' size='5'>가입하지 않은 아이디이거나, 잘못된 비밀번호입니다.</font>");
			}
			
		
		%>	
					<div><a href="" class="float-right" onclick="findForm()">아이디/비밀번호 찾기</a></div>
                     <input type="submit" class="btn btn-warning form-control"
                        value="로그인" style="margin-top: 21px;"> 
                      <input type="button" class="btn btn-warning form-control" value="회원가입" onclick ="location.href='joinForm'"
...
function findForm(){
    ...
    window.open("findForm",
               "아이디 비밀번호 찾기", "width=520, height=390, resizable = no, scrollbars = no left="+ popupX + ", top="+ popupY);    
           }
  	...
  	function checkValue()
		{
			...
			{
				alert("아이디를 입력하세요");	
				inputForm.user_id.focus(); //자기 텍스트 상자로 포커스
				return false;
			}
