...
crossorigin="anonymous">
    <title>아이디/비밀번호찾기findForm</title>
...
<body>
    ...
    <div class="row mt-3">
            ...
            <button id="btnId"  class=" btnMenu" onclick="displayId()"><i class="fas fa-user-tie"></i>아이디 찾기</button>
            <button id="btnPw" class=" btnMenu" onclick="displayPw()"><i class="fas fa-unlock-alt"></i>비밀번호 찾기</button>
        </div>
...
<!--  비번  찾기 -->
    ...
    <input type="submit" value="비밀번호찾기"  class="subBtn btn btn-warning">
    <input type="button" value="취소" onclick="window.close()" class="subBtn btn btn-primary">
    </form>    
