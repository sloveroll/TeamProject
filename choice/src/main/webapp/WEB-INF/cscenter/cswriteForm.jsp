...
<body>
   ...
   <div class="box-padding-big grey-bg"
      style="margin-top: -20px; height: 673px;">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td><textarea class="form-control" placeholder="상담글 내용"
                                 name="cs_content" value="" maxlength="2048"
   ...
   <!-- 고객센터사 상담글쓰기,글수정에 공백,띄어쓰기뿐일때 값없음 처리  -->
   <script>
      function submitContents() {
         var title = document.CscenterInfo.cs_title.value;
         var cont = document.CscenterInfo.cs_content.value;
