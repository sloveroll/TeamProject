...
<!-- header-->
   <div class="header">
      ...
      <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-warning">
         ...
         <a class="navbar-brand" href="http://localhost:8081/csList">고객센터-상담글수정게시판</a>
      ...
      <div class="container" style="height: 400px;">
         <div class="row" style="height: 400px;">
            ...
            <div class="col-md-10 col-sm-12" style="height: 200px;">
               ...
               <!--  Cscentermodify_ok로 작성내용 보냄. -->
               <form onsubmit="return submitContents()"
                  action="Cscentermodify_ok?cs_idx=${dto.cs_idx }"
                  method="post" name="CscenterInfo">
                  
                  <table cellpadding="0" cellspacing="0" border="1"
                     style="text-align: center; border: 1px;" class="noticewritetable"><!-- css파일 noticewritetable -->


                     <thead>
                        <tr>
                           <th colspan="2"
                              style="background-color: #eeeeee; text-align: center;">상담게시판
                              글쓰기 </th>
                        </tr>
                     </thead>
                     ...
                     <tbody>
                        <tr>
                           <td><input type="text" class="form-control"
                              placeholder="상담글 제목" name="cs_title" maxlength="50"
                              value="${ dto.cs_title }"></td>
                        </tr>
                        <tr>
                           <td><textarea class="form-control" placeholder="상담글 내용"
                                 id="textcontent" name="cs_content" maxlength="2048"
                                 style="height: 350px;">${ dto.cs_content }</textarea></td>
                        </tr>
                     </tbody>
                  ...
                  <input type="submit" class="btn btn-success pull-right"
                     value="글수정" style="float: right;" onClick="Cscentermodify_ok()"/>
   ...
   <!-- 고객센터 글쓰기,글수정에 공백,띄어쓰기뿐일때 값없음 처리  -->
   <script>
      /* 둘중에 아무거나 쓰면 됨 
      var cont = $('#texta').val();
      var cong = document.getElementById("texta");
      alert(cong.value + " 2" + cont);  */
      function submitContents() {
         var title = document.CscenterInfo.cs_title.value;
         var cont = $('#textcontent').val();
