...
public class ItemController {
	...
	public String itemDetail(HttpServletRequest req, Model model) throws Exception {
		// index에서 상품을 누르고 이동했을 때 item_idx를 받아서 해당상품 정보를 가져온다
	...
	public String itemBuy(HttpServletRequest req, HttpSession session, Model model) throws Exception {
		...
		public String takeCoupon(HttpSession session, HttpServletRequest req, Model model, RedirectAttributes redirectAttributes) throws Exception {
			//아이디 있는지
